...
- 2026-02-24: Completed unplanned Orders bugfix for department feed Prisma validation error (`OrderPart.createdAt` query removed); evidence recorded in `PROGRESS_LOG.md` and `docs/AGENT_HANDOFF.md`.
