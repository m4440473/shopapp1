...
CREATE TABLE "new_Addon" (
    ...
    "affectsPrice" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_Addon" ("active", "createdAt", "departmentId", "description", "id", "isChecklistItem", "name", "rateCents", "rateType", "updatedAt") SELECT "active", "createdAt", "departmentId", "description", "id", "isChecklistItem", "name", "rateCents", "rateType", "updatedAt" FROM "Addon";
DROP TABLE "Addon";
