...
const DEFAULT_QUOTE_METADATA = Object.freeze({
...
async function main() {
  ...
  const addonSeeds = [
    // Machining - Labor rates (pricing only, not checklist)
    ...
    { name: 'Mill Time', rateType: 'HOURLY', rateCents: 8200, departmentName: 'Machining', isChecklistItem: false },
    { name: 'Lathe Time', rateType: 'HOURLY', rateCents: 7800, departmentName: 'Machining', isChecklistItem: false },
    { name: 'Saw Cut', rateType: 'HOURLY', rateCents: 7500, departmentName: 'Machining', isChecklistItem: false },
    // Machining - Checklist tasks
    { name: 'Deburr', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    { name: 'Break edges / chamfer', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    { name: 'Verify critical dims', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    { name: 'In-process inspection', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    { name: 'Final inspection', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    { name: 'Clean part', rateType: 'FLAT', rateCents: 0, departmentName: 'Machining', isChecklistItem: true },
    // Fab - Labor rates (pricing only, not checklist)
    { name: 'Weld Time', rateType: 'HOURLY', rateCents: 9000, departmentName: 'Fab', isChecklistItem: false },
    { name: 'Fit-up / Tack', rateType: 'HOURLY', rateCents: 8500, departmentName: 'Fab', isChecklistItem: false },
    { name: 'Grind/Blend', rateType: 'HOURLY', rateCents: 8000, departmentName: 'Fab', isChecklistItem: false },
    // Fab - Checklist tasks
    { name: 'Cut stock for fab', rateType: 'FLAT', rateCents: 0, departmentName: 'Fab', isChecklistItem: true },
    { name: 'Prep joints', rateType: 'FLAT', rateCents: 0, departmentName: 'Fab', isChecklistItem: true },
    { name: 'Weld complete', rateType: 'FLAT', rateCents: 0, departmentName: 'Fab', isChecklistItem: true },
    { name: 'Blend/finish welds', rateType: 'FLAT', rateCents: 0, departmentName: 'Fab', isChecklistItem: true },
    // Paint - Checklist tasks (all are tasks)
    { name: 'Powder Coat', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Wet Paint', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Anodize', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Black Oxide', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Plating', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Zinc', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Masking', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Surface prep / scuff', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Cure complete', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    { name: 'Color match verified', rateType: 'FLAT', rateCents: 0, departmentName: 'Paint', isChecklistItem: true },
    // Shipping - Checklist tasks (all are tasks)
    { name: 'Flat Rate Handling', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Packaging', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Palletize', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Bag & tag', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Label parts', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Include paperwork', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Verify quantity', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
    { name: 'Ship complete', rateType: 'FLAT', rateCents: 0, departmentName: 'Shipping', isChecklistItem: true },
  ];
  ...
  function buildAddonsForPart(partIndex) {
    const names = addonGroups[partIndex % addonGroups.length] ?? [];
    return names.map((name) => addonByName.get(name)).filter(Boolean);
  }

  async function seedOrder(idx, customerId, assigned, business, lifecycleStage = 'MACHINING') {
  ...
  const orderSeeds = [
    { idx: 1, customerId: acme.id, assigned: null, business: 'STD', lifecycleStage: 'NEW' },
    { idx: 2, customerId: wayne.id, assigned: mach1.id, business: 'STD', lifecycleStage: 'MACHINING' },
    { idx: 3, customerId: stark.id, assigned: mach2.id, business: 'CRM', lifecycleStage: 'FAB' },
    { idx: 4, customerId: oscorp.id, assigned: mach1.id, business: 'PC', lifecycleStage: 'PAINT' },
    { idx: 5, customerId: acme.id, assigned: mach2.id, business: 'STD', lifecycleStage: 'COMPLETED' },
    { idx: 6, customerId: wayne.id, assigned: null, business: 'CRM', lifecycleStage: 'NEW' },
    { idx: 7, customerId: stark.id, assigned: mach1.id, business: 'PC', lifecycleStage: 'MACHINING' },
    { idx: 8, customerId: oscorp.id, assigned: mach2.id, business: 'STD', lifecycleStage: 'FAB' },
    { idx: 9, customerId: acme.id, assigned: mach1.id, business: 'CRM', lifecycleStage: 'PAINT' },
    { idx: 10, customerId: wayne.id, assigned: mach2.id, business: 'STD', lifecycleStage: 'COMPLETED' },
    { idx: 11, customerId: stark.id, assigned: null, business: 'PC', lifecycleStage: 'NEW' },
    { idx: 12, customerId: oscorp.id, assigned: mach1.id, business: 'CRM', lifecycleStage: 'MACHINING' },
    { idx: 13, customerId: acme.id, assigned: mach2.id, business: 'STD', lifecycleStage: 'FAB' },
    { idx: 14, customerId: wayne.id, assigned: mach1.id, business: 'PC', lifecycleStage: 'PAINT' },
    { idx: 15, customerId: stark.id, assigned: mach2.id, business: 'CRM', lifecycleStage: 'COMPLETED' },
    { idx: 16, customerId: oscorp.id, assigned: mach1.id, business: 'STD', lifecycleStage: 'MACHINING' },
  ];
