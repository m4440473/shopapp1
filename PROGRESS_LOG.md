...
- Authenticated Chrome verified saved-quote edit navigation, all three quote/order part-entry choices, new PDF/ZIP importer, local split without OCR, enabled upload after One-off selection, and order edit mode exposing Save order/Save part; zero console errors and no record/model submission. The owner explicitly authorized publication to the public `m4440473/shopapp1` repository and merge of PR #179; `docs/PRODUCTION_ACCESS.md` remains local-only and is excluded from the public payload.
